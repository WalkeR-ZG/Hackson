...
const string SINGEVERTRX_PATH = "TopoDesignData/data-SingleRoot/";
const string MULTIVERTRX_PATH = "TopoDesignData/data-MultiRoots/";
const string BIGDATA_PATH = "TopoDesignData/data-big/";
const string BIGDATA_OUTPUT_PATH = "output/data-big/";
const string SINGEVERTRX_OUTPUT_PATH = "output/data-SingleRoot/";
